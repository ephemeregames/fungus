(function() {
  ...
  this.Timer = (function() {
    ...
    Timer.prototype.update = function() {
      ...
      if (this._accumulatedTime < this.target) return;
      if (this.skipFrames) {
  ...
  this.Fatal = (function() {
    ...
    function Fatal() {
      ...
      this.setPlatformUnsupported = __bind(this.setPlatformUnsupported, this);
      var _this = this;
  ...
  Scenes = (function() {
    ...
    function Scenes() {
      ...
      var _this = this;
      this.canvas = new Canvas3D($(window));
  ...
  Launcher = (function() {
    ...
    function Launcher() {
      ...
      try {
        ...
        if (error === "PlatformUnsupported") this._fatal.setPlatformUnsupported();
